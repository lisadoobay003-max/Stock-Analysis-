...
The sections of the intial codes highlight a test description of the LSTM model equations for input gate, forget gate and output gate, and the  Taylor's rule, data preprocessing of all 3 datasets, canada_top_5_bank_news(5).csv, sotck_data_2021_06_19_to_2026_06_19.csv and target_overnight_rate_canada.csv, exploratory data analysis, and some implementation of the LSTM model and Bert model for the top 5 banks of Canada for sentiment, financial, quantitative, and technical analyses. 
